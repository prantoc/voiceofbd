         ...
         <div class="news-items">
            <div class="row news-item-0">
               <div class="col-xl-9 col-lg-8 news-root-container-0">
                    <ol class="d-flex" style="padding: 0; margin: 8px 0 16px;">
                        ...
                        @if(!empty($singlePost->location_id))
                          <li class="breadcrumb-item" aria-current="page"><a href="{{route ('location', $singlePost->location->slug)}}">{{$singlePost->location->name}}</a>
                        </li>
                        @endif
                      </ol>
                  <article class="details-body" lg-uid="lg0">
                     ...
                     <div class="d-flex align-items-center">
                        <div style="width: 38px;height: 38px;border-radius: 19px; overflow: hidden;">
                           <img class="author-image" style="width: 100%;" src="{{ Voyager::image($singlePost->authorId->avatar) }}">
                        </div>
                     ...
                     <div class="mb-0 share-top mt-2 d-flex align-items-center d-print-none justify-content-between" style="overflow: auto">
                        ...
                        <div class="mb-0 d-flex align-items-center fs-mapper fs-mapper-0" style="pointer-events: auto;">
                           <button type="button" class="btn btn-light social-icon share-social-icon fsi fsi-0">
                           ফ+
                           </button>
                           <button type="button" class="btn btn-light social-icon share-social-icon fsd fsd-0">
                           ফ-
                           </button>
                        </div>
                     </div>
                     ...
                     <div class="news-image gallery">
                        <a href="{{ Voyager::image( $singlePost->image ) }}"><img src="{{ Voyager::image( $singlePost->image ) }}" alt="{{$singlePost->title}}" class="lg-image"></a>
                     ...
                     <div class="tags d-flex align-items-center flex-wrap d-print-none">
                        <div class="view-more-round" style="margin: 5px;">
                           <a style="color: #000;" href="{{route ('tag', $singlePost->category->slug)}}">{{$singlePost->category->name}}</a>
                        </div>
                     </div>
                  </article>
                  <div class="d-print-none">
                     <div class="py-3 m-py-2">
                        <div class="category-header d-flex justify-content-between align-items-center mt-2" style="padding:17px 0;">
               ...
               <div class="col-xl-3 col-lg-4 d-print-none">
                  <div class="sticky-container probash">
                     <div class="right-ad-0 advertisement d-flex justify-content-center" style="height: 250px">
                        @if(!empty($adOne))
                           <div class="advertisement">
                              <a href="{{$adOne->ad_link}}" target="_blank" class="d-flex justify-content-center">
                                <img src="{{ Voyager::image( $adOne->ad_img ) }}" alt="" style="width: 298px; height:240px;">
                              </a>
                           </div>
                        @endif
                     </div>
                     <div class="fy-selective third-right">
                        <div class="you-items pt-2">
                           <div class="category-header politics-ch d-flex justify-content-between align-items-center politics__home mt-2" style="padding:17px 0;">
                              <div class="heading politics-heading">
                                 <p class="title">আপনার জন্য</p>
                              </div>
                           </div>
                           <div class="regular-list scaled m-px-0">
                              @foreach($randomPosts as $fbp)
                              <a href="{{route('single-post', $fbp->slug)}}" class="news-item news-item-regular py-2">
                                 <div class="image-container">
                                    <img src="{{ Voyager::image( $fbp->image ) }}" data-src="#" alt="{{$fbp->title}}" class="img-loader" width="330" height="175">
                                 </div>
                                 <h2 class="title">{{$fbp->title}}</h2>
                              </a>
                              @endforeach
                        ...
                        <div class="same-category-items pt-2">
                           <div class="category-header politics-ch d-flex justify-content-between align-items-center politics__home mt-2" style="padding:17px 0;">
                              <div class="heading politics-heading">
                                 <p class="title"><a href="{{route('post',$cat->slug)}}" class="politics-lc">{{$cat->name}} থেকে আরও</a></p>
                              </div>
                           </div>
                           <div class="regular-list scaled m-px-0">
                              @foreach($relatedPosts as $fbp)
                              <a href="{{route('single-post', $fbp->slug)}}" class="news-item news-item-regular py-2">
                                 <div class="image-container">
                                    <img src="{{ Voyager::image( $fbp->image ) }}" data-src="#" alt="{{$fbp->title}}" class="img-loader" width="330" height="175">
                                 </div>
      ...
      <div class="row mb-3">
         <div class="col-lg-8">
            <div class="container pt-2 pb-lg-3 px-lg-5">
               <div class="row">
                  <div class="col-lg-4 col-md-12 col-sm-12 d-flex justify-content-lg-start justify-content-xl-start justify-content-center">
                     <img  height="75" width="300" src="{{ Voyager::image( Voyager::setting('site.logo')) }}" alt="">
                  </div>
            ...
            <ol class="d-flex" id="no-printme" style="padding: 0; margin-bottom: 8px;">
               ...
               @if(!empty($singlePost->location_id))
               <li class="breadcrumb-item" aria-current="page"><a>{{$singlePost->location->name}}</a>
               </li>
               @endif
            </ol>
            <h1 class="news-title">{{$singlePost->title}}</h1>
