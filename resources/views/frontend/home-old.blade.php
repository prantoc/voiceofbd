            ...
            <div class="col-lg-3 col-md-6 top-list-1 order-md-1 order-lg-0">
               <div class="advertisement mt-2">
                  <a href="#" target="_blank" class="d-flex justify-content-center">
                    <img src="{{asset('assets/img/copa2.jpg')}}" alt="" style="width: 100%; height:100px;">
                  </a>
              </div>
          ...
          <div class="col-lg-3 col-md-4 custom-item">
            ...
            <div class="row mt-2" style="margin: 0">
              <form action="" >
                <div class="col-12" style="padding: 5px 0">
                  <div class="form-group" style="margin: 0">
                    <select class="form-select form-search-select" name="division" id="division">
                      {{-- <option>জেলা</option> --}}
                      <option value="0" disabled selected>জেলা*</option>
                ...
                <div class="col-12" style="padding: 5px 0">
                  <div class="form-group" style="margin: 0">
                    <select class="form-select form-search-select" name="upazila" id="upazila" placeholder="উপজেলা">
                      <option value="0" disabled selected>উপজেলা</option>
                    </select>
                  </div>
                </div>
